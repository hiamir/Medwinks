...
<!-- Email Address -->
    <div>
        ...
        <div class="relative">
            ...
            <x-forms.auth-input wire:model="email" type="text" name="login-email"
    ...
    <div class="mt-4">
        ...
        <div class="relative">
            ...
            <x-forms.auth-input wire:model="password" type="password" name="login-password"
                                placeholder="••••••••••••••••••"></x-forms.auth-input>
        </div>
        <x-forms.form-error field="password"></x-forms.form-error>
    </div>

    <x-forms.auth-submit-button name="Login" class="!mt-10"></x-forms.auth-submit-button>
