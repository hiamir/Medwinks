<div id="toast"
     ...
     class="transition duration-150 ease-in-out absolute w-full max-w-xs p-4 flex items-center text-gray-500 bg-white rounded-lg shadow bottom-5 right-5 dark:text-gray-400 dark:bg-gray-800 dark:text-gray-400 dark:bg-gray-900" role="alert">
