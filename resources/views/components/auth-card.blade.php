...
@if($type==="two_factor")
    ...
    @else
    relative p-4 xs:w-[90%] sm:w-[80%] md:w-[50%] lg:w-[40%] xl:w-[450px] min-w-md bg-blue-100 rounded-lg border border-gray-200 shadow-md dark:drop-shadow-md2 sm:p-6 lg:p-8
    @endif
