...
<div
    ...
    'flex justify-center text-center text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 rounded-lg inline-flex items-center text-xs uppercase focus:ring-4 focus:outline-none font-medium rounded-lg text-sm text-center  tracking-widest': modalDetails.modalType==='delete' || modalDetails.modalType==='passwordReset'
    }"
>
    <div wire:loading.inline wire:loading.attr="disabled" wire:target="submit" class="px-5 py-2.5 absolute top-0 left-0">
    ...
    <button :name="modalDetails.formType" type="submit"
            {{ $attributes->merge(['class'=>'flex w-full justify-center px-5 py-2.5 text-xs uppercase tracking-widest font-medium flex w-100 items-center mt-0']) }}
