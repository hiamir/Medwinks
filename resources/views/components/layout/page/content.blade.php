@props(['header'=>''])
    ...
    dark:scrollbar-thumb-gray-500 dark:scrollbar-track-gray-700">
        <!-- Main content header -->
        <div class="flex flex-col justify-center xs:items-center min-h-[75px] justify-between py-4 space-y-4 border-b dark:border-gray-700 lg:items-center lg:space-y-0 sm:flex-row">
