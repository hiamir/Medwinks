<x-auth-card header="Sign in to admin panel" guard="admin">
    ...
    <!-- Email Address -->
        <div>
            ...
            <div class="relative">
                ...
                <x-forms.auth-input wire:model.defer="email" type="text" name="email" placeholder="name@omjmanager.com"></x-forms.auth-input>
            </div>
        ...
        <div class="mt-4">
            ...
            <div class="relative">
                ...
                <x-forms.auth-input  wire:model.defer="password" type="password" name="password" placeholder="••••••••••••••••••"></x-forms.auth-input>
            </div>
