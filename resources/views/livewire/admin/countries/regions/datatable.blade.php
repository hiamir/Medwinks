<x-datatable.main>
    ...
    <x-datatable.modal.modal
        x-data="{
        header:$wire.entangle('header'),
        modalSize:$wire.entangle('modalSize'),
        data:$wire.entangle('permission')
        }"
    >
        <x-form wire:submit.prevent="submit" class="space-y-6" novalidate autocomplete="off">
            <div class="mt-4">
                ...
                <div class="relative">
                    <x-input name="name" placeholder="Enter a unique permission name"
                             wire:model.defer="permission.name"></x-input>
                </div>
            ...
            <div class="mt-4">
                ...
                <div class="relative">
                    <x-forms.select wire:model.defer="permission.guard_name" name="permission.guard_name"
    ...
    {{--    DELETE MODAL--}}
    @isset($record)
        <x-datatable.modal.delete name="{{$record->name}}" icon="exclamation"> </x-datatable.modal.delete>
    @endisset
</x-datatable.main>
